...
def batch(iterable, n: int = 1) -> iter:
...
def translate_dataset(
    ...
    print("Terminating translation threads...")
    pool.close()
    pool.join()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="Number of threads that will simultaneously pre-process,"
        " send to the marian server (running on the GPU)"
        " and post-process sentences",
    )
